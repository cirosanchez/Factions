...
data class Mine(@Id val name: String, var displayName: String, var block: ItemStack, var reward: ItemStack, var claim: Region?, var cuboid: Cuboid?, val permission: String, var regenTime: Long) : MongoSerializable {
}