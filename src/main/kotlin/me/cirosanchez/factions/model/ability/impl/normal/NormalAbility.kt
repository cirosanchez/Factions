package me.cirosanchez.factions.model.ability.impl.normal
...
class NormalAbility(name: String, displayName: String, lore: List<String>, material: Material, type: AbilityType, val effects: List<PotionEffect>,
                    enabled: Boolean, val radius: Int
